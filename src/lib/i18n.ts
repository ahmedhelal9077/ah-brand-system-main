...
export const translations: Record<Language, TranslationDict> = {
  ar: {
    ...
    login: "تسجيل الدخول",
    logout: "تسجيل الخروج",
    trans_152: "عرض المزيد...",
    trans_153: "برجاء كتابة اسم الشنطة والسعر.",
    crm_title: "إدارة العملاء (CRM)",
    crm_desc: "تواصل مع عملائك بسهولة وزد مبيعاتك عبر العروض الحصرية",
    crm_search: "ابحث برقم الهاتف...",
    suppliers_title: "الموردين",
    audit_title: "جرد المخزن",
    total_orders: "الطلبات",
    customer_city: "المحافظة",
    customer_phone: "رقم الهاتف",
    customer_name: "اسم العميل",
    app_msg: "مراسلة",
    open_scanner: "فتح الماسح الضوئي (كاميرا)",
    close_scanner: "إغلاق الكاميرا",
  ...
  en: {
    ...
    crm_desc: "Connect with your customers and increase sales",
    crm_search: "Search by phone number...",
    suppliers_title: "Suppliers",
    audit_title: "Stock Audit",
    total_orders: "Orders",
    customer_city: "City",
    customer_phone: "Phone Number",
    customer_name: "Customer Name",
    app_msg: "Message",
    open_scanner: "Open Camera Scanner",
